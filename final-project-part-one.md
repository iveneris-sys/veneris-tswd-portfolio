| [home page](https://cmustudent.github.io/tswd-portfolio-templates/) | [data viz examples](dataviz-examples.md) | [critique by design](critique-by-design.md) | [final project I](final-project-part-one.md) | [final project II](final-project-part-two.md) | [final project III](final-project-part-three) |


# Outline
 
In my final project, I will explore energy in the United States. Specifically, I want to examine type of energy _generated_ and type of energy _consumed_, with an emphasis on regional impacts, from 2001-2024. Pointedly, I want to investigate how our energy mix is shifting away from fossil fuels to renewable energy. I want to depict this data using a map of the United States that changes according to the year, so that the change in energy mix is shown smoothly with an interactive aspect. 
